  ...
  return (
    <Page back="/create">
      <div className="relative flex flex-col p-[10px] mt-[20px] mb-[60px]">
        <p className="text-secondary font-[500] text-[20px]">TUNESSSSS</p>
        <p className="text-secondary text-[12px] leading-[20px] mt-[12px]">
          users generate fun audio of all genres
        </p>
        <div className="flex flex-col justify-center mt-[12px] w-[370px] h-[358px] border-[1px] border-[#4F5170] rounded-[8px]">
          {musicUrl ? (
